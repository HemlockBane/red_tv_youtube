...
class ExclusivesItemsScreen extends StatefulWidget {
  @override
  _ExclusivesItemsScreenState createState() => _ExclusivesItemsScreenState();
}

class _ExclusivesItemsScreenState extends State<ExclusivesItemsScreen> {
                  ...
                  Expanded(
                    child: Consumer<ExclusivesPlaylistNotifier>(
                      builder: (context, exclusives, _) {
                        final playlistItems = exclusives.playlist.filteredItems;
                        return Container(
                          // color: Colors.amber,
